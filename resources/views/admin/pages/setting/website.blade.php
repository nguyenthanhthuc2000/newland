                ...
                <div class="mT-30">
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                <label class="form-label" for="name">Tên công ty <span style="color: red;">*</span></label>
                            ...
                            <div class="mb-3 col-md-3">
                                <label class="form-label" for="hotline_1">Hotline 1 <span style="color: red;">*</span></label>
                            ...
                            <div class="mb-3 col-md-3">
                                <label class="form-label" for="hotline_2">Hotline 2 <span style="color: red;">*</span></label>
                            ...
                            <div class="mb-3 col-md-3">
                                <label class="form-label" for="email">Email CSKH <span style="color: red;">*</span></label>
                            ...
                            <div class="mb-3 col-md-3">
                                <label class="form-label" for="domain">Tên miền <span style="color: red;">*</span></label>
                                <input type="text" class="form-control"  value="{{$settingsWeb->domain}}" name="domain" id="domain">
                                @error('domain')
                                <span class="error " style="    font-size: small; color:red;">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="mb-3 col-md-4">
                                <label class="form-label" for="zalo">Zalo <span style="color: red;">*</span></label>
                            ...
                            <div class="mb-3 col-md-4">
                                <label class="form-label" for="youtube">Youtube <span style="color: red;">*</span></label>
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="google_map">Google Map <span style="color: red;">*</span></label>
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-2">
                                <label class="form-label" for="logo">Logo Header <span style="color: red;">*</span></label>
                            ...
                            <div class="mb-3 col-md-2">
                                <label class="form-label" for="logo_footer">Logo Footer <span style="color: red;">*</span></label>
