...
<div class="list-article">
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
            ...
            data-bs-target="#allArticle" type="button" role="tab" aria-controls="allArticle" aria-selected="true">Tất cả bài viết <strong>({{ $personalArticle->count() }})</strong></button>
        </li>
         <li class="nav-item" role="presentation">
            <button class="nav-link" id="profile-tab" data-bs-toggle="tab"
            data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Bài viết chưa được duyệt</button>
        </li>
        {{-- <li class="nav-item" role="presentation">
