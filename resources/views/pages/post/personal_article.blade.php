    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="home-tab" data-bs-toggle="tab"
                    data-bs-target="#allArticle" type="button" role="tab" aria-controls="allArticle"
                    aria-selected="true">Tất cả bài viết <strong>({{ $personalArticle->count() }})</strong></button>
        </li>
         <li class="nav-item" role="presentation">
            <button class="nav-link" id="profile-tab" data-bs-toggle="tab"
                    data-bs-target="#articlesUnverified" type="button" role="tab" aria-controls="profile"
                    aria-selected="false">Bài viết chưa được duyệt <strong>({{ $articlesUnverified->count() }})</strong></button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="contact-tab" data-bs-toggle="tab"
                    data-bs-target="#articlesCanled" type="button" role="tab" aria-controls="contact"
                    aria-selected="false">Bài viết bị hủy <strong>({{ $articlesCanled->count() }})</strong></button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="contact-tab" data-bs-toggle="tab"
                    data-bs-target="#deposited" type="button" role="tab" aria-controls="contact"
                    aria-selected="false">Đã đặt cọc <strong>({{ $articlesDeposited->count() }})</strong></button>
        </li>
    </ul>
    <div class="tab-content" id="personalArticle">
        <div class="tab-pane fade show active" id="allArticle" role="tabpanel" aria-labelledby="allArticle-tab">
            @if ($personalArticle->count() == 0)
                <strong>Khồng có dữ liệu</strong>
            @else
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Trạng thái mua bán</th>
        ...
        <div class="tab-pane fade" id="articlesUnverified" role="tabpanel" aria-labelledby="articlesUnverified-tab">
            @if ($articlesUnverified->count() == 0)
                <strong>Khồng có dữ liệu</strong>
            @else
            <table class="table table-hover">
                <thead>
                ...
                <tbody>
                    @foreach ($articlesUnverified as $i => $art)
                    @php
                        $img_article[] = $art->imagesArticle->toArray();
                        $img = $img_article[$i] ? $img_article[$i][0]['image'] : '';
                    @endphp
        ...
        <div class="tab-pane fade" id="articlesCanled" role="tabpanel" aria-labelledby="articlesCanled-tab">
            @if ($articlesCanled->count() == 0)
                <strong>Khồng có dữ liệu</strong>
            @else
            <table class="table table-hover">
                <thead>
                ...
                <tbody>
                    @foreach ($articlesCanled as $i => $art)
                    @php
                        $img_article[] = $art->imagesArticle->toArray();
                        $img = $img_article[$i] ? $img_article[$i][0]['image'] : '';
                    @endphp
        ...
        <div class="tab-pane fade" id="deposited" role="tabpanel" aria-labelledby="deposited-tab">
            @if ($articlesDeposited->count() == 0)
                <strong>Khồng có dữ liệu</strong>
            @else
            <table class="table table-hover">
                <thead>
                ...
                <tbody>
                    @foreach ($articlesDeposited as $i => $art)
                    @php
                        $img_article[] = $art->imagesArticle->toArray();
                        $img = $img_article[$i] ? $img_article[$i][0]['image'] : '';
                    @endphp
